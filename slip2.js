(function(WIN, DOC) {
    ...
    Slip = (function() {
        ...
        Slip.prototype.setCoord = function(userCoords,_ele) {
            var attr, coords,ele;
            coords = this.coord = {
                "x": userCoords[X] || 0,
                "y": userCoords[Y] || 0
        ...
        Slip.prototype.setAni = function(_duration,_ele) {
            if(!_ele)
            {
                setTransition(this.ele, "all " + _duration + "ms ease-out");
            }else{
                setTransition(_ele, "all " + _duration + "ms ease-out");
            }
